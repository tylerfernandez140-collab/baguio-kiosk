...
const KIOSK_2_POSITION = new THREE.Vector3(-5.95, 0.01, 1.54);
const HALLWAY_Z_K2 = 0.96;

const firstFloorPathsKiosk2: Record<string, THREE.Vector3[]> = {
  session_hall: [
    new THREE.Vector3(-5.95, 0.01, 1.54), 
    new THREE.Vector3(-5.95, 0.01, 0.96),
    new THREE.Vector3(5.72, 0.01, 0.96),
    new THREE.Vector3(5.72, 0.01, 1.15), 
  ],
  sh: [
  ...
  one_stop_shop: [
    new THREE.Vector3(-5.95, 0.01, 1.54), 
    new THREE.Vector3(-5.95, 0.01, 0.47),
    new THREE.Vector3(-7.75, 0.01, 0.47), 
  ],  
  'cr_one_stop+shop': [
    new THREE.Vector3(-5.95, 0.01, 1.54), 
    new THREE.Vector3(-5.95, 0.01, -0.70),
    new THREE.Vector3(-9.65, 0.01, -0.70),
  ],
  stairs: [
    new THREE.Vector3(-5.95, 0.01, 1.54), 
