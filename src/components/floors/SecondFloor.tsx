...
const secondFloorPaths: Record<string, THREE.Vector3[]> = {
  ...
  stairs: [
    ...
    new THREE.Vector3(-4.55, 0.01, 0.7),
    new THREE.Vector3(-6.9, 0.01, 0.7),
...
const secondFloorPathsKiosk2: Record<string, THREE.Vector3[]> = {
  OOTVM: [
    new THREE.Vector3(-7.76, 0.01, -1.53),
    new THREE.Vector3(-7.76, 0.01, 0.6),
    new THREE.Vector3(-2.2, 0.01, 0.6),
    new THREE.Vector3(-2.2, 0.01, -0.16),
  ],
  CLO: [
  ...
  CANTEEN: [
    new THREE.Vector3(-7.76, 0.01, -1.53),
    new THREE.Vector3(-7.76, 0.01, -0.76),
    new THREE.Vector3(-8.32, 0.01, -0.76),
  ],
  CADO: [
    new THREE.Vector3(-7.76, 0.01, -1.53),
  ...
  stairs: [
    new THREE.Vector3(-7.76, 0.01, -1.53),
    new THREE.Vector3(-7.76, 0.01, 0.7),
    new THREE.Vector3(-6.9, 0.01, 0.7),
    new THREE.Vector3(-6.9, 0.01, -1.09),
  ],
};
