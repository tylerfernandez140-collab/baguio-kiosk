...
export const officeImageMap: Record<string, string> = {
  ...
  COUN1:
    "committee_on_public_protection_and_safety_peace_and_order_and_human_rights_and_justice",
  ...
  COUN8:
    "committee_on_health_and_sanitation_ecology_and_environmental_protection",
